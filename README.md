...
- 💊 **데이터 분석/AI 학회 투빅스(ToBig's) 25기** — 25기 운영 부장으로 동아리를 이끌었습니다. 1) 25기 컨퍼런스에서 CV+OCR+LLM 복약지도 시스템 **PILLAR**에서 PM 및 Late-Fusion 단계를 수행했습니다. 2) 26기 컨퍼런스에서 ADMET 22종 예측 모델에서 입력 서열의 특성에 따른 불안정성 정량 플랫폼 **SENSE**에서 PM 역할을 수행했습니다.
