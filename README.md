...
- 💊 **데이터 분석/AI 학회 투빅스(ToBig's) 25기** — 25기 운영 부장으로 동아리를 이끌었습니다. <br>1) Computer vision, OCR, LLM을 이용한 복약지도 서비스 **PILLAR** <br>2) ADMET 예측 모델의 입력 서열 특성에 따른 불안정성 정량 플랫폼 **SENSE**
